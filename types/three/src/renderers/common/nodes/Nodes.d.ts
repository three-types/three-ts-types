...
declare class Nodes extends DataMap<{
     ...
     */
    getEnvironmentNode(scene: Scene): Node<unknown> | null;
    /**
     ...
     */
    getBackgroundNode(scene: Scene): Node<unknown> | null;
    /**
     ...
     */
    getFogNode(scene: Scene): Node<unknown> | null;
    /**
     ...
     */
    getOutputNode(outputTarget: Texture): Node<unknown>;
    /**
