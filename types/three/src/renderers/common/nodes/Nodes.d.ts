...
declare class Nodes extends DataMap<{
     ...
     */
    getEnvironmentNode(scene: Scene): Node<TNodeType> | null;
    /**
     ...
     */
    getBackgroundNode(scene: Scene): Node<TNodeType> | null;
    /**
     ...
     */
    getFogNode(scene: Scene): Node<TNodeType> | null;
    /**
     ...
     */
    getOutputNode(outputTarget: Texture): Node<TNodeType>;
    /**
