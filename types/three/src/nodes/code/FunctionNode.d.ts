...
export type FunctionNodeArguments = Node[] | { [name: string]: Node | number };

export default class FunctionNode<P extends Node[] | { [name: string]: Node | number }> extends CodeNode {
