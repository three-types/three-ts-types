...
declare const SampleNode: {
    new<TNodeType>(callback: (uv: Node<'vec2'>) => Node<TNodeType>, uvNode?: Node<'vec2'> | null): SampleNode<TNodeType>;
};
...
export const sample: <TNodeType>(callback: (uv: Node<'vec2'>) => Node<TNodeType>, uvNode?: Node<'vec2'> | null) => SampleNode<TNodeType>;
