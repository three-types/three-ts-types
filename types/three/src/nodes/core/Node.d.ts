...
type Node<TValue = unknown> =
    ...
    & (TValue extends "float" ? FloatExtensions & NumberExtensions<"float">
        ...
        : TValue extends "vec3"
            ? Vec3Swizzle & Vec3Extensions & Vector3Extensions<"float"> & FloatVectorExtensions<"vec3">
        ...
        : TValue extends "vec4"
            ? Vec4Swizzle & Vec4Extensions & Vector4Extensions<"float"> & FloatVectorExtensions<"vec4">
