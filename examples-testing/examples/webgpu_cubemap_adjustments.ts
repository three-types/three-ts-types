...
async function init() {
    ...
    const hdr1Texture = await new HDRLoader().loadAsync('./textures/equirectangular/pedestrian_overpass_1k.hdr');
    ...
    const hdr2Texture = await new HDRLoader().loadAsync('./textures/equirectangular/752-hdri-skies-com_1k.hdr');
