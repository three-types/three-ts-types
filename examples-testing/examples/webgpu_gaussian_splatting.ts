...
const sources = {
    millipede: {
        ...
        loader: SPLATLoader,
        rotation: new THREE.Euler(-Math.PI * -1.1, Math.PI * -0.1, Math.PI * 0.15),
        cameraPosition: new THREE.Vector3(0, 0.4, 1),
        credit: {
            author: 'Fabian Plum',
