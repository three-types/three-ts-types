...
function init() {
    ...
    scene.backgroundNode = screenUV.y.mix(color(0x66bbff), color(0x4466ff)).mul(0.05);
    camera.lookAt(0, 1, 0);
    ...
    postProcessing.outputNode = colorPass.add(gaussianBlur(maskPass, 1, 20).mul(0.3)).renderOutput();
