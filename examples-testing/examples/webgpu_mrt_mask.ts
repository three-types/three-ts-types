...
function init() {
    ...
    scene.backgroundNode = viewportTopLeft.y.mix(color(0x66bbff), color(0x4466ff)).mul(0.05);
    camera.lookAt(0, 1, 0);
    ...
    postProcessing.outputNode = colorPass.add(maskPass.gaussianBlur(1, 10).mul(0.3)).renderOutput();
