...
function initGUI(material: THREE.MeshSSSNodeMaterial) {
    ...
    gui.add(thicknessControls, 'distortion')
        .min(0.01)
        .max(1)
        .step(0.01)
        .onChange(function () {
    ...
    gui.add(thicknessControls, 'ambient')
        .min(0.01)
        .max(5.0)
        .step(0.05)
        .onChange(function () {
    ...
    gui.add(thicknessControls, 'attenuation')
        .min(0.01)
        .max(5.0)
        .step(0.05)
        .onChange(function () {
    ...
    gui.add(thicknessControls, 'power')
        .min(0.01)
        .max(16.0)
        .step(0.1)
        .onChange(function () {
    ...
    gui.add(thicknessControls, 'scale')
        .min(0.01)
        .max(50.0)
        .step(0.1)
        .onChange(function () {
