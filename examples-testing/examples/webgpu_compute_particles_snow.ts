...
async function init() {
    ...
    collisionPosRT.texture.format = THREE.RedFormat;
    ...
    collisionPosMaterial.blending = THREE.NoBlending;
    ...
    const computeUpdate = Fn(() => {
        ...
        const rippleOnSurface = texture(collisionPosRT.texture, getCoord(position.xz)).toInspector(
            'Collision Test',
            () => {
