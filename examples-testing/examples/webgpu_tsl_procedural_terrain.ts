...
function init() {
    ...
    terrainGui
        .addColor({ color: colorSand.value.getHexString(THREE.SRGBColorSpace) }, 'color')
        .name('colorSand')
        .onChange(value => colorSand.value.set(value));
    terrainGui
        .addColor({ color: colorGrass.value.getHexString(THREE.SRGBColorSpace) }, 'color')
        .name('colorGrass')
        .onChange(value => colorGrass.value.set(value));
    terrainGui
        .addColor({ color: colorSnow.value.getHexString(THREE.SRGBColorSpace) }, 'color')
        .name('colorSnow')
        .onChange(value => colorSnow.value.set(value));
    terrainGui
        .addColor({ color: colorRock.value.getHexString(THREE.SRGBColorSpace) }, 'color')
        .name('colorRock')
    ...
    waterGui
        .addColor({ color: water.material.color.getHexString(THREE.SRGBColorSpace) }, 'color')
        .name('color')
