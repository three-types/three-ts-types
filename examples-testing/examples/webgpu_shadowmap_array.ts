...
function createScenery() {
    ...
    const columnInstancedMesh = new THREE.InstancedMesh(columnGeometry, columnMaterial, columnCount);
    ...
    const sphereInstancedMesh = new THREE.InstancedMesh(sphereGeometry, sphereMaterial, sphereCount);
    ...
    const torusCount = 15;
    const torusInstancedMesh = new THREE.InstancedMesh(torusGeometry, torusMaterial, torusCount);
