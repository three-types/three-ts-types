...
export function ShaderNode(jsFunc: any, nodeType: any): any;
/**
...
export function nodeProxy(...params: any[]): any;
export function nodeImmutable(...params: any[]): any;
export function Fn(jsFunc: any, layout?: null): {
    (...params: any[]): any;
    shaderNode: any;
    id: any;
    isFn: boolean;
    getNodeType(...params: any[]): any;
    getCacheKey(...params: any[]): any;
    setLayout(layout: any): /*elided*/ any;
    once(subBuilds?: null): /*elided*/ any;
};
