...
declare class TextureNode extends UniformNode {
     ...
     * @return {string} The generated code snippet.
     */
    generateSnippet(builder: NodeBuilder, textureProperty: string, uvSnippet: string, levelSnippet: string | null, biasSnippet: string | null, depthSnippet: string | null, compareSnippet: string | null, gradSnippet: Array<string> | null): string;
    /**
