...
export function storageObject(value: StorageBufferAttribute | StorageInstancedBufferAttribute | BufferAttribute, type: string | null, count: number): StorageBufferNode;
/**
...
declare class StorageBufferNode extends BufferNode {
     ...
     * @default null
     */
    _attribute: BufferAttributeNode | null;
    /**
