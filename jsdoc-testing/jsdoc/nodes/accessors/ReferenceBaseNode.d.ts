...
export function reference(name: string, type: string, object: Object): ReferenceBaseNode;
export function referenceBuffer(name: string, type: string, count: number, object?: Object): ReferenceBaseNode;
/**
 ...
 * @augments Node
 */
declare class ReferenceBaseNode extends Node {
    /**
...
declare class ReferenceElementNode extends ArrayElementNode {
     ...
     */
    constructor(referenceNode: ReferenceBaseNode, indexNode: Node);
    /**
     ...
     * @default null
     */
    referenceNode: ReferenceBaseNode | null;
    /**
