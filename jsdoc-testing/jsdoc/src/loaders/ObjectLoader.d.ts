...
export class ObjectLoader extends Loader {
    ...
    parseObject(data: any, geometries: any, materials: any, textures: any, animations: any): Object3D | Sprite | LOD | Mesh | SkinnedMesh | InstancedMesh | BatchedMesh | Line | Points | OrthographicCamera | PerspectiveCamera;
