 ...
 * @constant
 */
export const InterpolateBezier: number;
/**
 ...
 * @constant
 */
export const RenderObjectRefreshType: ConstantsRenderObjectRefreshType;
/**
 ...
 * Represents the refresh types of render objects.
 */
export type ConstantsRenderObjectRefreshType = {
    /**
     * - No refresh required.
     */
    NONE: number;
