...
export function viewZToReversedOrthographicDepth(viewZ: Node<any>, near: Node<any>, far: Node<any>): Node<any>;
/**
 ...
 * @returns {Node<float>}
 */
export const orthographicDepthToViewZ: () => void;
 ...
 * @returns {Node<float>}
 */
export const perspectiveDepthToViewZ: () => void;
