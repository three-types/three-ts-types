 ...
 * @type {Node<vec3>}
 */
export const bitangentGeometry: Node<vec3>;
/**
 ...
 * @type {Node<vec3>}
 */
export const bitangentLocal: Node<vec3>;
/**
 ...
 * @type {Node<vec3>}
 */
export const bitangentView: Node<vec3>;
/**
 ...
 * @type {Node<vec3>}
 */
export const bitangentWorld: Node<vec3>;
