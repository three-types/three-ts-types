...
export function transformNormalByViewMatrix(normal: Node<any>, viewMatrix: Node<mat3 | mat4>): Node<any>;
export function transformNormalByInverseViewMatrix(normal: Node<any>, viewMatrix: Node<mat3 | mat4>): Node<any>;
