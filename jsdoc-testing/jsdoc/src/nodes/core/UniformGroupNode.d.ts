...
export function uniformGroup(name: string, order?: number, updateType?: null): UniformGroupNode;
export function sharedUniformGroup(name: string, order?: number, updateType?: null): UniformGroupNode;
/**
