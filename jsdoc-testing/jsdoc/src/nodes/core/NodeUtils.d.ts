 ...
 */
export function getAlignmentFromType(type: string): number;
/**
 ...
 * @return {string} The data type.
 */
export function getTextureType(texture: Texture): string;
/**
...
export function isArrayAsParameter(params: any): any;
