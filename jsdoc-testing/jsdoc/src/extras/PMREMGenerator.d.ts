...
export class PMREMGenerator {
    ...
    _cubemapMaterial: {
         ...
         * (Heitz, 2018) to generate environment maps that accurately match the GGX BRDF
         * used in material rendering for physically-based image-based lighting.
         */ | number | AdditiveBlending | SubtractiveBlending | MultiplyBlending | CustomBlending);
        ...
        blendColor: Color;
        blendAlpha: number;
        depthFunc: (NeverDepth | AlwaysDepth | LessDepth | number | EqualDepth | GreaterEqualDepth | 
        /**
