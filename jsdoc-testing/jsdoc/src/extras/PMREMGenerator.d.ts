...
export class PMREMGenerator {
    ...
    _cubemapMaterial: {
        ...
        blendDstAlpha: (ZeroFactor | OneFactor | SrcColorFactor | OneMinusSrcColorFactor /**
         ...
         */ | number | number | DstAlphaFactor | OneMinusDstAlphaFactor | DstColorFactor | OneMinusDstColorFactor | SrcAlphaSaturateFactor | ConstantColorFactor | OneMinusConstantColorFactor | ConstantAlphaFactor | OneMinusConstantAlphaFactor) | null;
        ...
        clippingPlanes: Array<import("../Three.Core.js").Plane> | null;
