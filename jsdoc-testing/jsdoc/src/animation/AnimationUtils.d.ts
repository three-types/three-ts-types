 ...
 */
export function hasTangents(settings: Object | null): boolean;
/**
 ...
 */
export function flattenJSON(jsonKeys: Array<number>, times: Array<number>, values: Array<number>, valuePropertyName: string): void;
/**
 ...
 */
export function subclip(sourceClip: AnimationClip, name: string, startFrame: number, endFrame: number, fps?: number): AnimationClip;
/**
 ...
 */
export function makeClipAdditive(targetClip: AnimationClip, referenceFrame?: number, referenceClip?: AnimationClip, fps?: number): AnimationClip;
/**
...
export class AnimationUtils {
     ...
     * @return {boolean} Whether both tangent arrays are defined or not.
     */
    static hasTangents(settings: Object | null): boolean;
    /**
     * Returns an array by which times and values can be sorted.
     *
     * @static
