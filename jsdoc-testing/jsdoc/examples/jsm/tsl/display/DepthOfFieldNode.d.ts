...
export function dof(node: Node<any>, viewZNode: Node<float>, focusDistance?: Node<float> | number, focalLength?: Node<float> | number, bokehScale?: Node<float> | number): DepthOfFieldNode;
/**
...
declare class DepthOfFieldNode extends TempNode {
     ...
     */
    constructor(textureNode: TextureNode, viewZNode: Node<float>, focusDistanceNode: Node<float>, focalLengthNode: Node<float>, bokehScaleNode: Node<float>);
    /**
