...
export type GLTFExporter = {
    ...
    /**
     * - List of animations to be included in the export. When exporting a single 3D object or scene, this is a flat list of clips.
     ...
     */
    animations?: AnimationClip[] | AnimationClip[][] | undefined;
    /**
