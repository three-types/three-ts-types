 ...
 */
export class Sculptor extends EventDispatcher {
    /**
     ...
     */
    enabled: boolean;
    _sculptMesh: SculptorMesh;
    _sculpting: boolean;
    _activePointerId: any;
    _lastPointerX: number;
    _lastPointerY: number;
    _hitFace: number;
    _rayOrigin: number[];
    _rayDirection: number[];
    _hitPoint: number[];
    _hitNormal: number[];
    _localRadius2: number;
    _worldRadius2: number;
    _dragDirection: number[];
    _cachedRect: DOMRect | null;
    _lastTopologyVersion: number;
    _dirtyVertices: any[];
    _geometrySynced: boolean;
    ...
    _getRect(): DOMRect;
    _unproject(clientX: any, clientY: any, z: any, target: any): any;
    _project(point: any, target: any): any;
    _updatePointerRay(clientX: any, clientY: any): boolean;
    _updateMeshMatrix(): number;
    _updatePickingMatrices(): number;
    _clearHit(): void;
    _pickClosestFace(rayOrigin: any, rayDirection: any): boolean;
    _intersectionRayMesh(clientX: any, clientY: any, scale2: any): boolean;
    _updateRadii(scale2: any): void;
    _pickVerticesInSphere(radius2: any): Uint32Array<ArrayBuffer>;
    _computePickedNormal(): boolean;
    _dynamicTopology(pickedVertices: any): any;
    _intersectionFromRay(ray: any, worldRadius: any): boolean;
    /**
     ...
     */
    endStroke(): Sculptor;
    _applyStroke(scaleDelta?: number): void;
    _makeStroke(clientX: any, clientY: any, scale2: any): boolean;
    _sculptStroke(clientX: any, clientY: any): boolean;
    _updateDragDirection(clientX: any, clientY: any, scale2: any): boolean;
    _sculptStrokeDrag(clientX: any, clientY: any): boolean;
    _sculptStrokeScale(clientX: any, clientY: any): boolean;
    _markVerticesDirty(vertices: any): void;
    _syncGeometry(): void;
    _computeExactBounds(): void;
    /**
