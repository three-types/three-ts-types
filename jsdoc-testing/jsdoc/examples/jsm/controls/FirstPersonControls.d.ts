...
export class FirstPersonControls extends Controls {
    ...
    _keyForward: boolean;
    _keyBackward: boolean;
    _pointerForward: boolean;
    _pointerBackward: boolean;
    _moveLeft: boolean;
    _moveRight: boolean;
    _moveUp: boolean;
    _moveDown: boolean;
...
declare class onPointerDown {
    constructor(event: any);
    _pointerForward: boolean | undefined;
    _pointerBackward: boolean | undefined;
    _pointerDownX: any;
    _pointerDownY: any;
    _pointerX: number;
    _pointerY: number;
...
declare class onKeyDown {
    constructor(event: any);
    _keyForward: boolean | undefined;
    _moveLeft: boolean | undefined;
    _keyBackward: boolean | undefined;
