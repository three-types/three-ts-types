 ...
 */
export class InstancedMeshNode extends InstanceNode {
    /**
...
export class SkinningNode extends Node {
     ...
     * @type {Node<mat4>}
     */
    bindMatrixNode: Node<any>;
    /**
     * The bind matrix inverse node.
     *
     * @type {Node<mat4>}
     */
    bindMatrixInverseNode: Node<any>;
    /**
     ...
     */
    getSkinnedPosition(boneMatrices?: Node, position?: Node<any>): Node<any>;
    /**
     ...
     */
    getSkinnedNormalAndTangent(boneMatrices?: Node, normal?: Node<any>, tangent?: Node<any>): {
        skinNormal: Node<any>;
        skinTangent: Node<any>;
    };
    /**
     ...
     */
    getPreviousSkinnedPosition(builder: NodeBuilder): Node<any>;
    /**
...
export var TSL: Readonly<{
    ...
    arrayBuffer: (value: any) => ConstNode;
    asin: any;
    asinh: any;
    assign: any;
    atan: any;
    ...
    computeSkinning: (skinnedMesh: SkinnedMesh, toPosition?: Node<any>) => SkinningNode;
    ...
    property: (type: string, name?: string | null) => PropertyNode;
    quadBroadcast: any;
    ...
    textureSize: any;
    textureStore: (value: StorageTexture, uvNode: Node<any | any>, storeNode?: Node | null) => StorageTextureNode;
    thickness: any;
    time: any;
    ...
    uvec4: any;
    varying: any;
    varyingProperty: (type: string, name?: string | null) => PropertyNode;
    vec2: any;
    vec3: any;
    vec4: any;
...
declare class NodeBuilderState {
     ...
     */
    constructor(vertexShader: string, fragmentShader: string, computeShader: string, nodeAttributes: Array<NodeAttribute>, bindings: Array<BindGroup>, updateNodes: Array<Node>, updateBeforeNodes: Array<Node>, updateAfterNodes: Array<Node>, observer: NodeMaterialObserver, transforms?: Array<Object>);
    /**
