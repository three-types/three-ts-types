...
export class Matrix4 {
     ...
     * @return {Matrix4} A reference to this matrix.
     */
    makePerspective(left: number, right: number, top: number, bottom: number, near: number, far: number, coordinateSystem?: (number | number)): Matrix4;
    /**
     ...
     * @return {Matrix4} A reference to this matrix.
     */
    makeOrthographic(left: number, right: number, top: number, bottom: number, near: number, far: number, coordinateSystem?: (number | number)): Matrix4;
    /**
