...
const files = [
    ...
    'nodes/renderers/common/Renderer',
];
...
for (const file of files) {
    console.log(file);
    const fileContents = fs.readFileSync(path.join(inDir, `${file}.d.ts`), {
        encoding: 'utf-8',
    });
    ...
    if (argv[2] === 'copy') {
        ...
        const outFileContents = fs.readFileSync(path.join(inDir, `${file}.d.ts`), {
            encoding: 'utf-8',
        });
