...
class ShaderCallNodeInternal extends Node {
    ...
    call(builder) {
        ...
        const onceNS =
            shaderNode.namespace && shaderNode.namespace === builder.namespace ? builder.getNamespace('once') : 'once';
        ...
        if (shaderNode.layout) {
            ...
            const outputNode =
                inputNodes !== null || jsFunc.length > 1 ? jsFunc(inputNodes || [], builder) : jsFunc(builder);
...
export const Fn = (jsFunc, layout = null) => {
    ...
    const fn = (...params) => {
        ...
        const isArrayAsParameter =
            params[0] && (params[0].isNode || Object.getPrototypeOf(params[0]) !== Object.prototype);
