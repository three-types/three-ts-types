...
class WebGPUBackend extends Backend {
    ...
    constructor(parameters = {}) {
        ...
        this.parameters.compatibilityMode =
            parameters.compatibilityMode === undefined ? false : parameters.compatibilityMode;
        ...
        const compatibilityTextureCompare =
            typeof navigator === 'undefined' ? true : /Android/.test(navigator.userAgent) === false;
    ...
    async init(renderer) {
        ...
        if (parameters.device === undefined) {
            ...
            const adapter =
                typeof navigator !== 'undefined' ? await navigator.gpu.requestAdapter(adapterOptions) : null;
    ...
    get context() {
        ...
        if (context === undefined) {
            ...
            if ('setAttribute' in canvasTarget.domElement)
                canvasTarget.domElement.setAttribute('data-engine', `three.js r${REVISION} webgpu`);
