...
class WGSLNodeBuilder extends NodeBuilder {
    ...
    generateTextureDimension(texture, textureProperty, levelSnippet) {
        ...
        if (textureData.dimensionsSnippet[levelSnippet] === undefined) {
            ...
            textureDimensionNode = new VarNode(
                new ExpressionNode(`textureDimensions( ${textureDimensionsParams} )`, dimensionType),
            );
    ...
    isSampleCompare(texture) {
        return (
            ...
            this.renderer.hasCompatibility(Compatibility.TEXTURE_COMPARE)
        );
    }
    ...
    getUniformFromNode(node, type, shaderStage, name = null) {
        ...
        if (nodeData.uniformGPU === undefined) {
            ...
            if (
                ...
                const needsSampler =
                    node.value.isCubeTexture === true ||
                    (this.isUnfilterable(node.value) === false && texture.store === false);
...
`;
                ...
                if (varying.needsInterpolation) {
                    ...
                    if (varying.interpolationType) {
                        const samplingSnippet =
                            varying.interpolationSampling !== null ? `, ${varying.interpolationSampling} )` : ' )';
    ...
    isCustomStruct(nodeUniform) {
        ...
        const isAttributeStructType =
            (attribute.isBufferAttribute || attribute.isInstancedBufferAttribute) && bufferNode.structTypeNode !== null;
        ...
        for (const uniform of uniforms) {
            ...
            if (
                ...
                const needsSampler =
                    ...
                    (this.isUnfilterable(texture) === false && uniform.node.isStorageTextureNode !== true);
