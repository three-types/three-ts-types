        ...
        if (nodeBuilderState === undefined) {
            ...
            if (nodeBuilderState === undefined) {
                const createNodeBuilder = material => {
                    ...
                    if (
                        this.renderer.getOutputRenderTarget() ? this.renderer.getOutputRenderTarget().multiview : false
                    ) {
    ...
    getCacheKey(scene, lightsNode) {
        ...
        if (cacheKeyData.callId !== callId) {
            ...
            _cacheKeyValues.push(
                this.renderer.getOutputRenderTarget() && this.renderer.getOutputRenderTarget().multiview ? 1 : 0,
            );
