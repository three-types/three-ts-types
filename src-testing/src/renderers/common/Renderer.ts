...
class Renderer {
    ...
    _renderBundle(bundle, sceneRef, lightsNode) {
        ...
        const renderBundleNeedsUpdate =
            renderBundleData.renderContexts.has(renderContext) === false || bundleGroup.needsUpdate === true;
    ...
    _renderScene(scene, camera, useFrameBufferTarget = true) {
        ...
        const { bundles, lightsNode, transparent: transparentObjects, opaque: opaqueObjects } = renderList;
